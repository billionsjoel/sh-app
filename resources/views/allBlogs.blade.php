    ...
    <main class="container">
        ...
        <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
            <div class="col-md-6 px-0">
                <h1 class="display-4 fst-italic">{!! \Illuminate\Support\Str::limit($featured->title, 20) !!}</h1>
                <p class="lead my-3">{!! \Illuminate\Support\Str::limit($featured->body, 800) !!}</p>
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <p class="card-text mb-auto">{!! \Illuminate\Support\Str::limit($latest->body, 1000) !!}</p>
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <p class="mb-auto">{!! \Illuminate\Support\Str::limit($promoted->body, 1000) !!}</p>
